/* ═══════════════════════════════════════════════════════════
   NARRATOR.JS — Audiobook narrator for Difaa al-Aqidah
...
(function() {
  ...
  const STATE = {
    ...
    cardIndex: 0,
    cards: [],
    tabOrder: ['about','cards','responses'],
    tabIndex: 0,
  ...
  function onSpeedChange(val) {
    ...
    localStorage.setItem('da-narrator-speed', STATE.speed);
  }
  ...
  function onPitchChange(val) {
    ...
    localStorage.setItem('da-narrator-pitch', STATE.pitch);
  }
  ...
  function onKaraokeToggle(checked) {
    ...
    localStorage.setItem('da-narrator-karaoke', checked);
  }

  function onAutoScrollToggle(checked) {
    STATE.autoScroll = checked;
    localStorage.setItem('da-narrator-autoscroll', checked);
  }

  function onDuoToggle(checked) {
    STATE.duoReading = checked;
    localStorage.setItem('da-narrator-duo', checked);
  }
  ...
  function loadSettings() {
    STATE.speed = parseFloat(localStorage.getItem('da-narrator-speed')) || 1;
    STATE.pitch = parseFloat(localStorage.getItem('da-narrator-pitch')) || 1;
    STATE.karaokeEnabled = localStorage.getItem('da-narrator-karaoke') !== 'false';
    STATE.autoScroll = localStorage.getItem('da-narrator-autoscroll') !== 'false';
    STATE.duoReading = localStorage.getItem('da-narrator-duo') === 'true';
  }
